...
?>
<label>
	<input id="featured-image-id" class="normal-text" name="extend-give-wp[featured-image-id]" type="number" min="1" aria-describedby="featured-image-attachment-id" value="<?php echo esc_attr( $attachment_id ); ?>">
